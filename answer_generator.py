...
class Answer_Generator():
    def __init__(self, params):
        ...
        self.score_b_h = tf.Variable(tf.random_uniform([self.hidden_dim], -self.init_bound, self.init_bound, name='score_b'))
        
        self.score_W_uv = tf.Variable(tf.random_uniform([self.rnn_size, self.hidden_dim], -self.init_bound, self.init_bound,\
                                                        name='score_W_uv'))
        self.score_W_uq = tf.Variable(tf.random_uniform([self.rnn_size, self.hidden_dim], -self.init_bound, self.init_bound,\
                                                        name='score_W_uq'))
    ...
    def train_attention_model(self):
        ...
        with tf.variable_scope("attention"):
            ...
            for i in range(self.attention_round):  
                ...
                v, q, V, Q ,C_update= attention(V, Q, C)# update v,q, V,Q
